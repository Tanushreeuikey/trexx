...
function setup() {
  createCanvas(displayWidth-50,displayHeight-300,0,2000);
 ...
 //console.log(message)
  ...
  ground.addImage("ground",groundImage,200,300,displayWidth*300,20);
  //ground.x = ground.width /2;
  
  var pos= trex.position.x+20
  gameOver = createSprite(pos,100);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(pos,140);
